  ...
  return (
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            <nav class="flex-1 px-2 py-4 bg-gray-800">
              ...
              >
                ...
                <a href="/admin/Candidature" class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                    <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 mr-2"
                fill="none"
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        ...
        <div class="p-4">
            ...
            <h1>table de Absence Candidature</h1>
          ...
          <table class=" w-full table text-gray-400 border-separate space-y-6 text-sm">
              <thead class="bg-gray-800 text-gray-500">
                  <tr>
                      ...
                      <th class="p-3 text-left">Nombre de Absence </th>
                      <th class="p-3 text-left">Type & Date </th>
